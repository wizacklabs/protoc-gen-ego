...
var file_testdata_message_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
...
var file_testdata_message_proto_goTypes = []any{
	...
	(*Dog)(nil),        // 1: testdata.dog
	(*Cat)(nil),        // 2: testdata.cat
	(*Message)(nil),    // 3: testdata.message
	(*MessageMan)(nil), // 4: testdata.message.man
}
